#This is a test script to creat a gui in python
#I will first just look at a preset GUI by someone 
#afterwards im going to change it (clear all the stuff and insert a button)
#this butto will be used to start the main script
#the main script will be the h2o_genrator.py script
